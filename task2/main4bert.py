...
from data_utils4bert import data_collator, TextDataset
...
class Instructor:
    def __init__(self, args):
        ...
        self.trainset = TextDataset(args.dataset_file['train'], args.tokenizer)
    ...
    def _evaluate_acc_f1(self, data_loader):
        ...
        with torch.no_grad():
            for i_batch, t_batch in enumerate(data_loader):
                ...
                t_outputs = self.model(t_inputs, t_attn_mask)
